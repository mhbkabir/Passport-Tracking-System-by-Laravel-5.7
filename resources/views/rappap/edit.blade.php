    ...
    <div class="row" style="background: #fff; padding: 10px;margin-right: 0px;margin-left: 0px;">
        <div class="col-sm-6">
            <div class="row">
                ...
                <div class="col-sm-6"><b>Departure Date</b><br/> <input type="date" name="derpartureDate"
        ...
        <div class="control-group margintop15" id="q1" >
            <div class="row" style="background: #fff; padding: 10px;margin-right: 0px;margin-left: 0px;">
                ...
                <div class="col-md-2" style="padding-left:0;">
                    <div style="float: left;width: 120px;"><input type="text" required="required" name="contactNo[]"
                                                                  class="form-control contact_valid"
                                                                  value="{{$e_val->contact}}"
                                                                  placeholder="Contact No 10 Digit"><span
    ...
    <div class="addmorepart">
        ...
        <div class="control-group after-add-more margintop5" id="q1">
            <div class="row" style="background: #fff; padding: 10px;margin-right: 0px;margin-left: 0px;">
                ...
                <div class="col-md-2" style="padding-left:0;"><input type="text" name="contactNo[]"
